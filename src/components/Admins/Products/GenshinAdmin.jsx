// components/AdminProducts/GenshinAdmin.jsx
...
const GenshinAdmin = ({ collectionName}) => {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(colRef, (snapshot) => {
      const list = snapshot.docs
        ...
        .sort((a, b) => {
          // keep similar sorting: by api then price
