// components/AdminProducts/CustomAdmin.jsx
...
const CustomAdmin = ({ collectionName = "customproductlist" }) => {
  ...
  const groups = [
    { key: "group1", label: "1", image: undefined },
    { key: "group2", label: "2", image: undefined },
    { key: "group3", label: "3" },
    { key: "group4", label: "4", image: undefined },
    { key: "group5", label: "5", image: undefined },
  ];
  ...
  const fields = [
    ...
    {
      label: "Reseller Rupees",
      field: "resellerRupees",
      type: "number",
      placeholder: "Reseller Rupees",
    },
    {
      label: "False Rupees",
      field: "falseRupees",
  ...
  return (
    <div className={`py-6 px-2 ${isDark ? "bg-gray-800 text-gray-100" : "bg-white text-gray-900"}`}>
      ...
      <button
        ...
        className="fixed bottom-13 left-6 z-40 flex items-center justify-center w-14 h-14 rounded-full shadow-lg transform hover:-translate-y-0.5 transition bg-blue-600 text-white"
      >
        <FiPlus size={22} />
      </button>
    </div>
