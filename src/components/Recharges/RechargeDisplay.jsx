...
const gameInfo = {
  "/recharge/mlbb": {
    ...
    image: 'https://i.pinimg.com/1200x/71/c0/c0/71c0c0d9badbea70104b3ef0d0daa955.jpg',
    guide: [
...
return (
  <>
    {/* Mobile View */}
    <div className="relative w-full h-[180px] md:h-[250px] lg:hidden overflow-hidden"
      style={{
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="grid grid-cols-3 gap-1">
              {["24/7 Chat Support", "Safe Payment", "Official Store", "Service Guarantee", "Instant Delivery"].map((tag, i) => (
                <span
                  key={i}
                  className={`px-2 py-0.5 text-[8px] md:text-[9px] font-semibold rounded-md ${
                    isDarkMode
    ...
    <div className="hidden lg:block relative w-full h-[400px] overflow-hidden"
      style={{
        backgroundImage: `url(${currentGame.image})`,
        backgroundSize: "cover",
        backgroundPosition: "center",
        ...
        <div className="w-80 bg-white/95 backdrop-blur-md p-5 overflow-y-auto border-l-2 border-purple-300/30">
          ...
          <ol className="space-y-2.5">
            {currentGame.guide.map((step, i) => (
              <li key={i} className="flex gap-3 items-start group hover:bg-purple-50/50 p-2.5 -mx-2.5 transition-all duration-200">
                ...
                <span className="text-xs text-gray-700 leading-relaxed pt-1 group-hover:text-gray-900 transition-colors flex-1">{step}</span>
              </li>
            ))}
          </ol>
        </div>
        ...
        <div className="relative w-full max-w-2xl bg-white overflow-hidden animate-scale-in">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl md:text-2xl font-bold text-white">How to Purchase</h3>
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="bg-gray-50 px-6 py-5 border border-gray-200">
              <h4 className="text-sm font-bold text-gray-700 mb-4 uppercase tracking-wide">Step-by-Step Guide</h4>
              <ol className="space-y-3">
                {currentGame.guide.map((step, i) => (
                  <li key={i} className="flex gap-3">
                    ...
                    <span className="text-sm md:text-base text-gray-700 leading-relaxed pt-0.5">{step}</span>
                  </li>
                ))}
              </ol>
            </div>
