...
import SkinProductList from "../components/Recharges/ProductsList/SkinProductList";
import SkinCheckout from "../components/Recharges/SkinCheckout";
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-8 md:space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">
            Purchase skin products - orders will be processed manually
          </p>
        </div>
