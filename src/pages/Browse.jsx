...
const Browse = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br py-12 transition-colors ${isDark ? "from-gray-900 via-gray-900 to-gray-800" : "from-gray-50 via-purple-50/30 to-indigo-50/30"}`}>
